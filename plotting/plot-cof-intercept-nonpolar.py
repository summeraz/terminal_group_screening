...
nonpolar_groups = ['cyclopropyl', 'ethylene', 'isopropyl', 'methyl', 'phenyl']
polar_groups = ['acetyl', 'amino', 'carboxyl', 'cyano', 'fluorophenyl',
                'hydroxyl', 'methoxy', 'nitro', 'nitrophenyl', 'perfluoromethyl',
                'pyrrole']
...
for i, terminal_group in enumerate(terminal_groups):
    if terminal_group in nonpolar_groups:
...
plt.ylim([0, 4.5])
plt.tight_layout()
plt.savefig('cof-intercept-nonpolar.pdf')
