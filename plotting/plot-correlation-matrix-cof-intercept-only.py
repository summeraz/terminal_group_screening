...
variables = ['Molecular weight', 'Dipole moment', 'Chain length', 'COF', 'Intercept',
             ...
             'Interdigitation', 'Δ Interdigitation', 'Roughness',
             'Interaction energy']
correlation_matrix = np.load('correlation-matrix-cof-intercept-only.npy')
...
plt.tight_layout()
plt.savefig('correlation-heatmap-cof-intercept-only.pdf')
